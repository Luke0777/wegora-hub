    ...
    <div className={`w-full h-full flex items-center justify-center ${className}`}>
      ...
      >
        ...
        <g transform="translate(100, 80)">
          ...
          {/* Invoice header */}
          <rect x="-28" y="-38" width="56" height="6" rx="3" fill="#8B5CF6" opacity="0.3" />
          <rect x="-28" y="-28" width="40" height="3" rx="1.5" fill="#8B5CF6" opacity="0.2" />
          
          {/* Invoice line items */}
          <g transform="translate(-25, -15)">
            {/* Item 1 - umlagefähig */}
            <rect x="0" y="0" width="45" height="3" rx="1.5" fill="#8B5CF6" opacity="0.2" />
            ...
            {/* Item 2 - umlagefähig */}
            <rect x="0" y="8" width="40" height="3" rx="1.5" fill="#8B5CF6" opacity="0.2" />
            ...
            <rect x="0" y="16" width="42" height="3" rx="1.5" fill="#8B5CF6" opacity="0.2" />
            ...
            {/* Item 4 - umlagefähig */}
            <rect x="0" y="24" width="38" height="3" rx="1.5" fill="#8B5CF6" opacity="0.2" />
            ...
            {/* Item 5 - umlagefähig */}
            <rect x="0" y="32" width="43" height="3" rx="1.5" fill="#8B5CF6" opacity="0.2" />
          ...
          <rect x="-28" y="28" width="56" height="8" rx="4" fill="#8B5CF6" opacity="0.1" />
          <rect x="-22" y="31" width="30" height="2" rx="1" fill="#8B5CF6" opacity="0.3" />
        </g>

        {/* AI Scanning beam */}
        <g transform="translate(60, 80)">
          {/* Scanning lines moving across document */}
          <path d="M0,-20 L50,-20" stroke="#8B5CF6" strokeWidth="2" opacity="0.6" strokeDasharray="4,2" />
          <path d="M0,-10 L50,-10" stroke="#8B5CF6" strokeWidth="2" opacity="0.4" strokeDasharray="4,2" />
          <path d="M0,0 L50,0" stroke="#8B5CF6" strokeWidth="2" opacity="0.6" strokeDasharray="4,2" />
          <path d="M0,10 L50,10" stroke="#8B5CF6" strokeWidth="2" opacity="0.4" strokeDasharray="4,2" />
        </g>
        ...
        <g transform="translate(40, 140)">
          {/* AI chip */}
          <rect x="-15" y="-15" width="30" height="30" rx="4" fill="#8B5CF6" opacity="0.2" stroke="#8B5CF6" strokeWidth="2" />
          <circle cx="0" cy="0" r="8" fill="#8B5CF6" />
          <text x="0" y="4" textAnchor="middle" fill="#FFFFFF" fontSize="8" fontWeight="bold">AI</text>
          
          {/* Chip connections */}
          <path d="M-15,-8 L-20,-8" stroke="#8B5CF6" strokeWidth="1.5" />
          <path d="M-15,0 L-20,0" stroke="#8B5CF6" strokeWidth="1.5" />
          <path d="M-15,8 L-20,8" stroke="#8B5CF6" strokeWidth="1.5" />
          <path d="M15,-8 L20,-8" stroke="#8B5CF6" strokeWidth="1.5" />
          <path d="M15,0 L20,0" stroke="#8B5CF6" strokeWidth="1.5" />
          <path d="M15,8 L20,8" stroke="#8B5CF6" strokeWidth="1.5" />
        </g>
        ...
        <g transform="translate(165, 50)">
          ...
          <circle cx="0" cy="0" r="8" fill="#8B5CF6" opacity="0.1" />
          <path d="M9,9 L16,16" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" />
          
          {/* Magnified content indicator */}
          <text x="0" y="3" textAnchor="middle" fill="#8B5CF6" fontSize="8" fontWeight="bold">€</text>
        </g>

        {/* Data flow arrows */}
        <g opacity="0.4">
          <path d="M65,100 Q50,120 50,135" stroke="#8B5CF6" strokeWidth="2" fill="none" strokeDasharray="3,3" />
          <path d="M135,100 Q150,120 150,130" stroke="#8B5CF6" strokeWidth="2" fill="none" strokeDasharray="3,3" />
          
          {/* Arrow heads */}
          <path d="M50,135 L47,132 L53,132" fill="#8B5CF6" />
          <path d="M150,130 L147,127 L153,127" fill="#8B5CF6" />
        </g>
        ...
        <g transform="translate(35, 50)">
          ...
          <path d="M-4,0 L-1,3 L5,-3" stroke="#8B5CF6" strokeWidth="1.5" fill="none" strokeLinecap="round" />
        </g>
        ...
        <circle cx="25" cy="30" r="2.5" fill="#8B5CF6" opacity="0.5" />
        <circle cx="175" cy="25" r="2" fill="#8B5CF6" opacity="0.5" />
        <circle cx="185" cy="185" r="3" fill="#8B5CF6" opacity="0.5" />
        <circle cx="15" cy="180" r="2" fill="#8B5CF6" opacity="0.5" />
      </svg>
    </div>
  );
}
